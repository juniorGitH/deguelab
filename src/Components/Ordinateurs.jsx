...
const Ordinateurs = () => {
  ...
  const loadArticles = async () => {
    try {
      ...
      if (data.length === 0) {
        setErrorMessage("Aucun ordinateur trouvé.");
      }
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-6">
            Notre Catalogue d'Ordinateurs
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Découvrez notre sélection d'ordinateurs portables et de bureau. Tous nos produits sont neufs et garantis.
          </p>
        </div>
        ...
        {isLoading ? (
          <div className="text-center py-20">
            ...
            <p className="mt-4 text-gray-600">Chargement des ordinateurs...</p>
          </div>
        ) : errorMessage ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-600 text-xl">Aucun ordinateur disponible pour le moment.</p>
          </div>
        ) : (
